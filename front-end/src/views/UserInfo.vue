    ...
    <div class="plane">
        ...
        <div v-if="userInfo.phone">
            <Row class="text-item">
                ...
                <i-col span="12">
                    <Input v-model="userInfo.nikename" :value="userInfo.nikename" placeholder="输入昵称"
                           style="width: auto"/>
                </i-col>
            </Row>
            <Row class="text-item">
            ...
            <Row class="text-item">
                ...
                <i-col span="12">
                    <Input v-model="userInfo.age" v-bind:value="userInfo.age" placeholder="输入年龄" type="number"
                           style="width: auto"/>
                </i-col>
            </Row>
            <br>
